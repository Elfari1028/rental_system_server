...
class SupportRequest(models.Model):
    ...
    u_id = models.ForeignKey(
        'Users', on_delete=models.CASCADE, null=False, related_name='sr_u_id')
    ...
    res_u_id = models.ForeignKey(
        'Users', on_delete=models.CASCADE, null=True, related_name='sr_res_u_id')

    # 接入维修工（外键）
    fix_u_id = models.ForeignKey(
        'Users', on_delete=models.CASCADE, null=True, related_name='sr_fix_u_id')
